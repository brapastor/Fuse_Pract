// This file was generated based on '/usr/local/share/uno/Packages/UnoCore/0.19.6/Targets/CPlusPlus/Source/Uno/_main.cpp'.
...
namespace g{namespace Fuse{namespace iOS{namespace NativeViews{struct ParentNativeView_type; ::g::Fuse::iOS::NativeViews::ParentNativeView_type* Panel_typeof();}}}}
...
namespace g{namespace Fuse{struct Behavior_type; namespace Android{namespace NativeViews{::g::Fuse::Behavior_type* Panel_typeof();}}}}
...
namespace g{namespace iOS{namespace UIKit{struct UIResponder_type; ::g::iOS::UIKit::UIResponder_type* UIImagePickerController_typeof();}}}
namespace g{namespace iOS{namespace UIKit{struct UIResponder_type; ::g::iOS::UIKit::UIResponder_type* UINavigationController_typeof();}}}
namespace g{namespace iOS{namespace UIKit{struct UIResponder_type; ::g::iOS::UIKit::UIResponder_type* UIViewController_typeof();}}}
